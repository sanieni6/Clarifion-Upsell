  ...
  return (
    <header>
      <div className="bg-backHeader flex justify-between md:justify-normal py-[10px] px-[20px] gap-1 h-[42px] md:h-[50px]">
        <button onClick={handlePrevClick} className="md:hidden">
          <img src={arrowLeft} alt="Prev" />
        </button>
        <div className="flex items-center gap-1 md:hidden">
          <img src={elements[currentIndex][0]} alt="" />
          <p className="leading-[12px] font-medium text-white text-[12px]">
            {elements[currentIndex][1]}
          </p>
        </div>
        <button onClick={handleNextClick} className="md:hidden">
          <img src={rigthArrow} alt="" />
        </button>

        {/* Desktop */}
        <div className="hidden md:flex md:justify-around md:flex-1 md:p-4">
      ...
      <div
        className="flex items-center h-[60px] justify-between px-[20px] md:h-[96px]
